...
<div class="container">
    ...
    <form action="<?php echo e(route('admin.daerah.update', $daerah)); ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama" id="nama" class="form-control" value="<?php echo e(old('nama', $daerah->nama)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <textarea name="deskripsi" id="deskripsi" class="form-control"><?php echo e(old('deskripsi', $daerah->deskripsi)); ?></textarea>
        </div>
