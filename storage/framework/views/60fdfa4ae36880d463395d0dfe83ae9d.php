...
unset($__errorArgs, $__bag); ?>">
                <?php $__currentLoopData = ['modal pribadi','pinjaman keluarga','bank','koperasi/leasing','program pemerintah/lainnya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($s); ?>" <?php echo e(old('sumber_modal', $umkm->sumber_modal) == $s ? 'selected' : ''); ?>><?php echo e($s); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <textarea name="hambatan_pemasaran"
                      class="form-control <?php $__errorArgs = ['hambatan_pemasaran'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                      minlength="3" maxlength="50"><?php echo e(old('hambatan_pemasaran', $umkm->hambatan_pemasaran)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <textarea name="kebutuhan_pengembangan"
                      class="form-control <?php $__errorArgs = ['kebutuhan_pengembangan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                      minlength="3" maxlength="50"><?php echo e(old('kebutuhan_pengembangan', $umkm->kebutuhan_pengembangan)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('alamat', $umkm->alamat)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <select name="daerah_id"
                    class="form-control <?php $__errorArgs = ['daerah_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <select name="sektor_id"
                    class="form-control <?php $__errorArgs = ['sektor_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
