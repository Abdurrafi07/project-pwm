...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            <label>Pemilik</label>
            <input type="text" name="pemilik" value="<?php echo e(old('pemilik')); ?>" class="form-control <?php $__errorArgs = ['pemilik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            <label>No Telp</label>
            <input type="text" name="no_telp" value="<?php echo e(old('no_telp')); ?>" class="form-control <?php $__errorArgs = ['no_telp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="jumlah_karyawan" value="<?php echo e(old('jumlah_karyawan')); ?>" class="form-control <?php $__errorArgs = ['jumlah_karyawan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
