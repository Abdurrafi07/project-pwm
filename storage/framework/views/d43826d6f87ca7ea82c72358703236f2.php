...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <textarea name="deskripsi" id="deskripsi" class="form-control" rows="5"><?php echo e(old('deskripsi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="penulis" id="penulis" class="form-control" value="<?php echo e(old('penulis')); ?>">
